...
begin
  ...
  // Verificar se o pai é o TListBoxItem e buscar o TFRadioModulos
  ...
  begin
    ...
    begin
      ...
      // Alternar o status de ativação/desativação
      ...
      Exit; // Saída após encontrar o módulo
    end;
...
begin
  ...
  if sucesso then
    ...
    mensagem := 'Não foi possível concluir o processo!';
